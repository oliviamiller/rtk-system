...
func newRTKI2CNoNetwork(
	...
	I2CConfig := nmea.I2CConfig{I2CBus: newConf.I2CBus, I2cAddr: newConf.NMEAAddr}
	var err error
	nmeaConf := &nmea.Config{ConnectionType: i2cStr, I2CConfig: &I2CConfig}
	g.Nmeamovementsensor, err = nmea.NewI2CGPSNMEA(ctx, deps, name, nmeaConf, logger)
	if err != nil {
		return nil, err
	}
